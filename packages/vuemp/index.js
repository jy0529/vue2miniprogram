...
(function (global, factory) {
  ...
  function getEvents(vnode, e) {
    ...
    while(queue.length > 0) {
      ...
      if (
        ...
        Object.keys(on).forEach(function (etype) {
  ...
  function handleProxy(e) {
    var events = getEvents(this._vnode, e);
